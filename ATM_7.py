...
def create_message_window(title, message, action=None):
    ...
    message_window.configure(bg='#33ccff')
    ...
    tk.Label(message_window, text=formatted_message, font=('Helvetica', 12), bg='#33ccff', fg='#21618C', justify="center").pack(pady=20, anchor="center")
    if action:
...
def send_money():
    clear_screen()
    current_datetime = get_current_datetime()
    tk.Label(root, text="Enter Recipient Name", font=('Helvetica', 14), bg='#33ccff').pack(pady=10)
    recipient_name_entry = tk.Entry(root, font=('Helvetica', 12), justify="center")
    recipient_name_entry.pack(pady=5)
    tk.Label(root, text="Enter Amount to Send", font=('Helvetica', 14), bg='#33ccff').pack(pady=10)
...
def show_main_menu():
    clear_screen()
    tk.Label(root, text=" ATM Menu ", font=('Helvetica', 18, 'bold'), bg='#33ccff', fg='#21618C').pack(pady=20)
...
tk.Label(root, text="Welcome to HappyBank ATM", font=('Helvetica', 18, 'bold'), bg='#33ccff', fg='#21618C').pack(pady=20)
tk.Label(root, text="Please insert your card and enter your username", font=('Helvetica', 14), bg='#33ccff').pack(pady=10)

tk.Label(root, text="Enter Your Username", font=('Helvetica', 14), bg='#33ccff').pack(pady=10)
username_entry = tk.Entry(root, font=('Helvetica', 12), justify="center")
username_entry.pack(pady=5)

tk.Label(root, text="Enter Your PIN", font=('Helvetica', 14), bg='#33ccff').pack(pady=10)
